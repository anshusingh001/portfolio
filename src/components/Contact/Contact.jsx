...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // You can handle form submission logic here, such as sending form data to a server
    ...
    <Container>
      <Wrapper>
        ...
        <ContactForm  onSubmit={handleSubmit}>
          ...
          <ContactInputMessage placeholder="Message" rows="4" name="message" value={formData.value} onChange={handleChange}/>
